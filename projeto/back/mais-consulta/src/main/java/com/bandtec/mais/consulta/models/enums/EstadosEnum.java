...
public enum EstadosEnum {
     ...
     */
    EstadosEnum(final String nome, final String sigla, final String capital) {
        this.nome = nome;
        this.sigla = sigla;
     ...
     */
    public static EstadosEnum fromUF(final String nomeUf) {
        for (final EstadosEnum uf : EstadosEnum.values()) {
     ...
     */
    public static EstadosEnum fromSigla(final String sigla) {
        for (final EstadosEnum uf : EstadosEnum.values()) {
     ...
     */
    public static EstadosEnum fromCapital(final String capital) {
        for (final EstadosEnum uf : EstadosEnum.values()) {
