...
public interface ConsultaRepository extends JpaRepository<Consult, Integer> {
    ...
    Optional<List<SchedulingResponseDTO>> findAllConsultaByIdUser(@Param("id") Integer idUser);

    List<Consult> findConsultasByAgendamento_Status(SchedulingStatusEnum status);
